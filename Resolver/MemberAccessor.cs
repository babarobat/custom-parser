...
internal static class MemberAccessor
{
    ...
    internal static bool TryGetIndex(object? target, int index, out object? value)
    {
        value = null;
        if (target is null)
            return false;
    ...
    internal static bool TryGetMember(object? target, string member, out object? value)
    {
        value = null;
        if (target is null)
            return false;
